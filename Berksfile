...
cookbook 'kagent', github: "hopshadoop/kagent-chef", branch: "mml"
cookbook 'hops', github: "hopshadoop/hops-hadoop-chef", branch: "master"
cookbook 'ndb', github: "hopshadoop/ndb-chef", branch: "master"
cookbook 'hadoop_spark', github: "hopshadoop/spark-chef", branch: "mml"
...
cookbook 'tensorflow', github: "hopshadoop/tensorflow-chef", branch: "mml"
