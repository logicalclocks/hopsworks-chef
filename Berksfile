...
cookbook 'hops', github: "logicalclocks/hops-hadoop-chef", branch: "opensearch_fixes"
...
cookbook 'elastic', github: "logicalclocks/elasticsearch-chef", branch: "opensearch_fixes"
