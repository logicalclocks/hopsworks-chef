...
cookbook 'hadoop_spark', github: "hopshadoop/spark-chef", branch: "flyway"
...
cookbook 'tensorflow', github: "hopshadoop/tensorflow-chef", branch: "flyway"

cookbook 'epipe', github: "hopshadoop/epipe-chef", branch: "flyway"
cookbook 'dela', github: "hopshadoop/dela-chef", branch: "flyway"

cookbook 'kzookeeper', github: "hopshadoop/kzookeeper", branch: "flyway"
...
cookbook 'hive2', github: "hopshadoop/hive-chef", branch: "flyway"
