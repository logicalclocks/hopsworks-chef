...
cookbook 'hops', github: "gibchikafa/hops-hadoop-chef", branch: "cadvisor_config"
...
cookbook 'hopsmonitor', github: "gibchikafa/hopsmonitor-chef", branch: "cadvisor_configuration"
