...
cookbook 'kagent', github: "logicalclocks/kagent-chef", branch: "encryption_at_rest"
cookbook 'hops', github: "logicalclocks/hops-hadoop-chef", branch: "encryption_at_rest"
