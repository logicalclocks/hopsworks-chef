...
cookbook 'hops', github: "logicalclocks/hops-hadoop-chef", branch: "localhost"
cookbook 'ndb', github: "logicalclocks/ndb-chef", branch: "localhost"
cookbook 'hadoop_spark', github: "logicalclocks/spark-chef", branch: "localhost"
...
cookbook 'tensorflow', github: "logicalclocks/tensorflow-chef", branch: "localhost"
