...
cookbook 'conda', github: "maismail/conda-chef", branch: "CLOUD-97"
cookbook 'kagent', github: "logicalclocks/kagent-chef", branch: "master"
cookbook 'hops', github: "maismail/hops-hadoop-chef", branch: "CLOUD-97"
...
cookbook 'cloud', github: "maismail/cloud-chef", branch: "CLOUD-97"
