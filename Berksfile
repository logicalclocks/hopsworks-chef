...
cookbook 'elastic', github: "logicalclocks/elasticsearch-chef", branch: "opensearch_upgrade"
cookbook 'hopslog', github: "logicalclocks/hopslog-chef", branch: "opensearch_upgrade"
