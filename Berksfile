...
cookbook 'hops', github: "hopshadoop/hops-hadoop-chef", branch: "hops"
cookbook 'ndb', github: "hopshadoop/ndb-chef", branch: "master"
cookbook 'hadoop_spark', github: "hopshadoop/spark-chef", branch: "hops"
cookbook 'flink', github: "hopshadoop/flink-chef", branch: "hops"
cookbook 'zeppelin', github: "hopshadoop/zeppelin-chef", branch: "hops"
cookbook 'livy', github: "hopshadoop/livy-chef", branch: "hops"
cookbook 'drelephant', github: "hopshadoop/dr-elephant-chef", branch: "hops"
