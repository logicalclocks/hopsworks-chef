...
cookbook 'kagent', github: "logicalclocks/kagent-chef", branch: "opensearch"
cookbook 'hops', github: "logicalclocks/hops-hadoop-chef", branch: "fuse_upgrade_fix"
...
cookbook 'kube-hops', github: "logicalclocks/kube-hops-chef", branch: "opensearch"
