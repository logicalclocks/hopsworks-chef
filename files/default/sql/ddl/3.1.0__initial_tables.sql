...
CREATE TABLE `jobs` (
                        ...
                        KEY `project_id` (`project_id`),
                        KEY `creator_project_idx` (`uid`,`project_id`),
...
CREATE TABLE `topic_acls` (
                              ...
                              CONSTRAINT `user_fk_kafka_acls` FOREIGN KEY (`uid`) REFERENCES `users` (`uid`) ON DELETE NO ACTION ON UPDATE NO ACTION,
...
CREATE TABLE `feature_store_activity` (
                                          ...
                                          CONSTRAINT `fs_act_expectationsuite_fk` FOREIGN KEY (`expectation_suite_id`) REFERENCES `expectation_suite` (`id`) ON DELETE CASCADE ON UPDATE NO ACTION
) ENGINE=ndbcluster DEFAULT CHARSET=latin1 COLLATE=latin1_general_cs;
