...
CREATE TABLE IF NOT EXISTS `feature_view_statistics` (
                                           ...
                                           `row_percentage` DECIMAL(15,2) NOT NULL DEFAULT 1.00,
                                           `transformed_with` INT(11) DEFAULT NULL, -- training dataset id whose transformation functions were applied before computing statistics
                                           ...
                                           UNIQUE KEY `fv_ids_window_event_times_commit_time_row_perc_fk` (`feature_view_id`, `window_start_event_time`, `window_end_event_time`, `commit_time`, `row_percentage`, `transformed_with`),
                                           UNIQUE KEY `fv_ids_window_commit_times_row_perc_fk` (`feature_view_id`, `window_start_commit_time`, `window_end_commit_time`, `row_percentage`, `transformed_with`),
