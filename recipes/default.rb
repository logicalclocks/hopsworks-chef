...
if node['install']['enterprise']['install'].casecmp? "true"
  node.override['hopsworks']['ear_url'] = "#{node['install']['enterprise']['download_url']}/hopsworks/#{node['hopsworks']['version']}/hopsworks-ear#{node['install']['kube'].casecmp?("true") == 0 ? "-kube" : ""}.ear"
